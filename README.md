...
python main.py
  ...
  <!-- Screenshots -->
  <details>
    <summary style="cursor:pointer; color:#a6b3c0"><b>🖼️ Capturas (abre para ver)</b></summary>
    <div style="display:flex; gap:10px; flex-wrap:wrap; margin-top:10px">
      <img src="" alt="Mapa y GUI" style="width:48%; min-width:260px; border:1px solid #30363d; border-radius:10px"/>
    </div>
  </details>
